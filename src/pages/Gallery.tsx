...
const Gallery = () => {
  ...
  useEffect(() => {
    ...
    const imageFiles = [
      ...
      'WhatsApp Image 2025-12-30 at 10.55.02 PM.jpeg',
      // 29/12/2025 - New Year greeting formal announcement (additional photo)
    ...
    const galleryImages = imageFiles.map((fileName) => {
      ...
      if (fileName === 'WhatsApp Image 2025-12-14 at 07.22.17_7025e63f.jpg') {
        ...
        location = fileName === 'calendar-namakkal-rdo-2025-12-23.jpg' ? 'நாமக்கல் வருவாய் கோட்டாட்சியர் அலுவலகம்' : 'குமாரபாளையம் வட்டாட்சியர் அலுவலகம்';
        ...
        location = 'மாவட்ட ஆட்சியர் அலுவலகம், நாமக்கல்';
      } else if (fileName === 'WhatsApp Image 2025-12-30 at 10.55.02 PM.jpeg') {
        location = 'மாவட்ட ஆட்சியர் அலுவலகம், நாமக்கல்';
      ...
      return {
        ...
        name:
          ...
          ? 'மாவட்ட செயற்குழு கூட்டம் – 20/09/2025 (சிறப்பு அழைப்புனர்: திரு. வி.சுந்தர்ராஜன்; தலைமையில்: திரு.ரா. சரவணகுமார்)'
              ...
              : fileName === 'calendar-collage-district-office-2025-12-22.jpg'
              ? '2026ம் ஆண்டு மாத நாட்காட்டி - மாவட்ட ஆட்சியர் அலுவலகம், நாமக்கல் (22/12/2025)'
              : fileName === 'dro-meeting-2025-12-22.jpg'
              ...
              : fileName === 'calendar-namakkal-rdo-2025-12-23.jpg'
              ...
              : fileName === 'WhatsApp Image 2025-12-30 at 10.55.02 PM.jpeg'
